...
const Education = ({ greenIsOpen, onClose }) => {
  return (
    <div
      className={`fixed left-0 bottom-12 h-82 w-80 md:w-92 md:h-74 saturate-300 bg-square-green text-primary rounded-r-md shadow-lg transition-all duration-400 ease-in-out ${
        greenIsOpen
