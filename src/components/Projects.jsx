...
const Projects = ({ redIsOpen, onClose }) => {
  return (
    <div
      className={`fixed top-0 left-4 md:left-16 h-100 w-88 md:w-140 md:h-100  overflow-scroll bg-[#954d4d] text-primary rounded-b-md shadow-lg transition-all duration-400 ease-in-out ${
        redIsOpen
