...
const Contact = ({ yellowIsOpen, onClose }) => {
  return (
    ...
    >
        ...
        <div className="p-4 flex flex-row items-center justify-center gap-2 md:gap-4 -mt-6 ">
            <div className=" w-12 h-12 justify-around invert brightness-0 items-center
